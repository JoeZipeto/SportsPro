...
* Date: March 2, 2016
* Description: Surveys.aspx file where we allow the user to input a customer id and it displays the
* 				closed cases. This allows the user to complete a survey based on how the 
*               case was handled
*********************************************************************************************/
